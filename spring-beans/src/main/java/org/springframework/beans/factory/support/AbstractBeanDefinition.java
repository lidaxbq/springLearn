...
//  false:在自动装配时，这个bean不被考虑作为其他bean自动装配的候选者
...
// 是否是用户定义的bean，而不是应用程序本身定义的，在AOP生成的动态代理bean上，会被设置成true
//	synthetic 合成的
	private boolean synthetic = false;
// 定义这个bean的使用者，ROLE_APPLICATION：用户，ROLE_INFRASTRUCTURE：内部使用，与用户无关。ROLE_SUPPORT：某些复杂配置的一部分
