	...
	protected void renderMergedOutputModel(
		...
		if (useInclude(request, response)) {
			...
			if (logger.isDebugEnabled()) {
				logger.info("Including resource [" + getUrl() + "] in InternalResourceView '" + getBeanName() + "'");
			}
			...
			if (logger.isDebugEnabled()) {
				logger.info("Forwarding to resource [" + getUrl() + "] in InternalResourceView '" + getBeanName() + "'");
			}
