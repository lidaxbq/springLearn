...
/**
 * 实现 InitializingBean 接口，继承 AbstractHandlerMapping 抽象类，以 Method 作为 Handler 的 HandlerMapping 抽象类，
...
//	mapping	在 RequestMappingHandlerMapping 中，就是 @RequestMapping 解析成的 RequestMappingInfo 对象。
