...
public class WebContentInterceptor extends WebContentGenerator implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if (logger.isDebugEnabled()) {
			logger.info("Looking up cache seconds for [" + lookupPath + "]");
		}
		...
		if (cacheControl != null) {
			if (logger.isDebugEnabled()) {
				logger.info("Applying CacheControl to [" + lookupPath + "]");
			}
			...
			if (logger.isDebugEnabled()) {
				logger.info("Applying default cache seconds to [" + lookupPath + "]");
			}
